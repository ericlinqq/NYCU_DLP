...
def plot_curve(rec_dict, epoch, path, step = 5):
    ...
    fig.set_figheight(8)
    fig.set_figwidth(20)
    ax[0].plot(epochs, rec_dict['tfr'], linestyle='--', color='blue', label = "tfr")
    ax[0].plot(epochs, rec_dict['KL_weight'], linestyle='--', color='green', label = "KL weight")
    ax1 = ax[0].twinx()
    ax1.plot(epochs, rec_dict['kld'], 'y', label = "KL loss")
    ...
    ax[1].plot(epochs, rec_dict['tfr'], linestyle='--', color='blue', label = "tfr")
    ax[1].plot(epochs, rec_dict['KL_weight'], linestyle='--', color='green', label = "KL weight")
    ax2 = ax[1].twinx()
    ax2.plot(epochs2, rec_dict['psnr'], 'o', color='red', label = "psnr")
